...
//        e.g https://github.com/Smaranika02/events-app-api-server.git might become https://github.com/MyName/external.git
...
//      https://github.com/Smaranika02/events-app-api-server.git
//      smaranika02
//      api-server-image
//      cnd-events-cluster 
//      us-east-1  
...
pipeline {
   ...
   environment {
        ...
        imageName = 'smaranika02/api-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'main',
                    url: 'https://github.com/Smaranika02/events-app-api-server.git'
        ...
        stage('Building image') {
         ...
         stage('update k8s') {
            ...
            steps {
                echo 'Set the image'
                     sh "kubectl -n user01 set image deployment/demo-api demo-api=${env.imageName}:${env.BUILD_NUMBER} --kubeconfig=${WORKSPACE}/.kube/config"
            }
        }     
